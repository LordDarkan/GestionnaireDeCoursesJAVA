...
public class ListeAppelantInfoControllerFXMLNew extends ListeAppelantController implements Initializable,ITabController {
	@FXML
    ...
    @FXML
    private ListView<?> listViewAppelant;
    ...
    public ListeAppelantInfoControllerFXMLNew(MainControllerFXML main, Utilisateur user, TabPane tabContainer) {
    	super(user);
    	this.main = main;
    	Tab tab = null;
		try {
